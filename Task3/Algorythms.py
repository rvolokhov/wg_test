...
columns_count = 20
rows_count = 10
# the more the ratio the less land cells are on the map, 3 means 30% probability
random_ratio = 3
...
def check_neighbours(current_node: Node, steps_number) -> int:
    global foundNode
    ...
    if current_node.pos_x < columns_count - 1:
        if maze[current_node.pos_y][current_node.pos_x + 1] == 0:
            if maze_steps[current_node.pos_y][current_node.pos_x + 1] == 0 or maze_steps[current_node.pos_y][current_node.pos_x + 1] > steps_number:
                maze_steps[current_node.pos_y][current_node.pos_x + 1] = steps_number
                check_neighbours(Node(current_node.pos_x + 1, current_node.pos_y), steps_number + 1)
    ...
    if current_node.pos_y < rows_count - 1:
        if maze[current_node.pos_y + 1][current_node.pos_x] == 0:
            if maze_steps[current_node.pos_y + 1][current_node.pos_x] == 0 or maze_steps[current_node.pos_y + 1][current_node.pos_x] > steps_number:
                maze_steps[current_node.pos_y + 1][current_node.pos_x] = steps_number
                check_neighbours(Node(current_node.pos_x, current_node.pos_y + 1), steps_number + 1)
...
if __name__ == '__main__':
    ...
    canvas.bind("<Button-1>", click_mlb)
    # bind right mouse button click
    canvas.bind("<Button-3>", click_mrb)
    generate_map()
    init()
